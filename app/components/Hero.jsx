    ...
    <div className="fixed top-0 w-full z-50">
      <Navbar fluid rounded className="dark:bg-slate-200 bg-slate-200" id="navbar">
        ...
        <Navbar.Collapse>
          ...
          <Navbar.Link href="/images/resume.pdf" className="text-black dark:text-black">Resume</Navbar.Link>
        </Navbar.Collapse>
      </Navbar>
      </div>
