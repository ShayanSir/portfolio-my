...
function Home() {
  ...
  return (
    <>
      <div id="home" className="w-screen h-[50%] border-b-gray-400 border-[1px] lg:h-screen first-line: flex bg-gray-200 pb-6 pt-8 backdrop-blur-2xl lg:static lg:w-auto lg:bg-gray-200 lg:p-4">
        <div className="justify-center pl-6 py-[150px]" data-aos="fade-down">
          <h1 className="md:text-[100px] text-[40px] text-black font-bold leading-tight text-left">
            Muhammad Shayan <br /> Hussain
          </h1>
          <p  className="text-black text-left w-[250px] md:w-[350px] pt-2">
